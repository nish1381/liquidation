...
;(function($){
	...
	ScrollGallery.prototype = {
		...
		findElements: function() {
			...
			// control elements
			this.gallery = $(this.options.holder).addClass(this.options.galleryReadyClass + (this.options.vertical ? ' vertical' : ' horizontal'));
		...
		destroy: function() {
			...
			var unneededClasses = [this.options.galleryReadyClass, this.options.autorotationActiveClass, this.options.autorotationDisabledClass, (this.options.vertical ? ' vertical' : ' horizontal')];

...
jcf.addModule({
	...
	defaultOptions: {
		...
		uploadStructure:'<div class="jcf-input-wrapper"><div class="jcf-wrap"></div><label class="jcf-fake-input"><span><em></em></span></label><a class="jcf-upload-button btn-green"><span></span></a></div>',
	...
	setupWrapper: function(){
		...
		this.uploadButton.innerHTML = this.realElement.getAttribute('data-value') || this.options.buttonText;
	...
	refreshState: function(){
		...
		this.fileNameInput.innerHTML = this.getFileName() || this.origTitle || 'No file selected';
